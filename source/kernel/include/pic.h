...
#define I86_PIC_IRQ_CMOSTTIMER              0
...
extern uint8_t i86_picReadData(uint8_t picNum);

// Send a data byte from PIC
extern void i86_picSendData(uint8_t data, uint8_t picNum);

// Send operational command to PIC
extern void i86_picSendCommand(uint8_t cmd, uint8_t picNum);

// Enables and disables interrupts
extern void i86_picMaskIRQ(uint8_t irqmask, uint8_t picNum);

// Initialize pic
extern void i86_picInit(uint8_t base0, uint8_t base1);

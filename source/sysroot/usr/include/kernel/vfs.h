...
typedef struct fsNode {
    ...
    void*
        device; // Pointer to the device needed (unused mostly, most drivers will use impl_struct but you can use this)
} fsNode_t;

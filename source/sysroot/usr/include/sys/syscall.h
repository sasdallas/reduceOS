...
#define SYSCALL2(TYPE, NUM, ARG0, ARG1)                                                                                \
    ({                                                                                                                 \
        TYPE ret;                                                                                                      \
        asm volatile("int $0x80" : "=a"(ret) : "0"(NUM), "b"(ARG0), "c"(ARG1));                                        \
        ret;                                                                                                           \
    })
...
#define SYSCALL3(TYPE, NUM, ARG0, ARG1, ARG2)                                                                          \
    ({                                                                                                                 \
        TYPE ret;                                                                                                      \
        asm volatile("int $0x80" : "=a"(ret) : "0"(NUM), "b"(ARG0), "c"(ARG1), "d"(ARG2));                             \
        ret;                                                                                                           \
    })
...
#define SYSCALL4(TYPE, NUM, ARG0, ARG1, ARG2, ARG3)                                                                    \
    ({                                                                                                                 \
        TYPE ret;                                                                                                      \
        asm volatile("int $0x80" : "=a"(ret) : "0"(NUM), "b"(ARG0), "c"(ARG1), "d"(ARG2), "S"(ARG3));                  \
        ret;                                                                                                           \
    })
...
#define SYSCALL5(TYPE, NUM, ARG0, ARG1, ARG2, ARG3, ARG4)                                                              \
    ({                                                                                                                 \
        TYPE ret;                                                                                                      \
        asm volatile("int $0x80" : "=a"(ret) : "0"(NUM), "b"(ARG0), "c"(ARG1), "d"(ARG2), "S"(ARG3), "D"(ARG4));       \
        ret;                                                                                                           \
    })
...
#define SYSCALL6(TYPE, NUM, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5)                                                        \
    ({                                                                                                                 \
        ...
        "add $4, %%esp;"                                                                                               \
                     : "=a"(ret)                                                                                       \
                     : "g"(&p1p6), "a"(NUM), "c"(ARG1), "d"(ARG2), "S"(ARG3), "D"(ARG4)                                \
                     : "memory");                                                                                      \
        ret;                                                                                                           \
    })

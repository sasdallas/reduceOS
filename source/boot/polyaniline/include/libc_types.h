// libc_types.h - Provides all libc types needed
// Frankenstein since this code is compiled with host-based C libraries with EFI but not with BIOS, so stdint.h isn't needed.

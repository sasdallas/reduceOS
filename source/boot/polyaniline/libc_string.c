// libc_string.c - ported from reduced_libc, directly to Polyaniline
// Sort of VERY cobbled together. You'll notice a lot of random functions that just aren't used, and bad code.

...
HEADER_PROJECTS="libpolyhedron hexahedron external"      # Projects to install headers for. This is always done first
PROJECTS="libpolyhedron hexahedron external"             # Projects to enter and run make install.

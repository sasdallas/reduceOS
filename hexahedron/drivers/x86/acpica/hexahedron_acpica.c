...
#include <include/actbl.h>
#include <include/acexcep.h>
#include <include/acpiosxf.h>
...
ACPI_STATUS AcpiOsGetPhysicalAddress(void *LogicalAddress, ACPI_PHYSICAL_ADDRESS *PhysicalAddress) {
    ...
    *PhysicalAddress = (LogicalAddress - MEM_IDENTITY_MAP_REGION);
    return AE_OK;
}
...
bool AcpiOsReadable(void *Memory, ACPI_SIZE Length) {
    FUNC_UNIMPLEMENTED("AcpiOsReadable");
}

/* Are the memory regions writable? */
bool AcpiOsWritable(void *Memory, ACPI_SIZE Length) {
